...
if __name__ == "__main__":
    ...
    if SAGEMAKER_PROCESS:
        ...
        # define output files
        TRAIN_FILE= os.path.join(BASE_DIR, "files/train/train.csv")
        VAL_FILE= os.path.join(BASE_DIR, "files/validation/validation.csv")
        TEST_FILE= os.path.join(BASE_DIR, "files/test/test.csv")
        ...
        # define output files
        TRAIN_FILE= os.path.join(BASE_DIR, "data/weather/ekoue/cleaned/sagemaker divisions daily weather -- train.csv")
        VAL_FILE= os.path.join(BASE_DIR, "data/weather/ekoue/cleaned/sagemaker divisions daily weather -- val.csv")
        TEST_FILE= os.path.join(BASE_DIR, "data/weather/ekoue/cleaned/sagemaker divisions daily weather -- test.csv")
